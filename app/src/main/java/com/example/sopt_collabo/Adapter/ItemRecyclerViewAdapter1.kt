...
class ItemRecyclerViewAdapter1 (val ctx:Context, val data1List:List<HomeData>) : RecyclerView.Adapter<ItemRecyclerViewAdapter1.Holder>(){
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        Glide.with(ctx)
            .load(data1List[position].selector)
            .into(holder.selector1)
    ...
    inner class Holder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val selector1 : ImageView = itemView.findViewById(R.id.rv_item1_selector)
